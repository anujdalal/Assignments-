 ...
 * 
 */
@WebServiceClient(name = "ServiceImplService", targetNamespace = "http://ws.ad.com/", wsdlLocation = "http://localhost:9999/ws/hello?wsdl")
    ...
    extends Service
{
    ...
    private final static QName SERVICEIMPLSERVICE_QNAME = new QName("http://ws.ad.com/", "ServiceImplService");
    ...
    public ServiceInt getServiceImplPort() {
        return super.getPort(new QName("http://ws.ad.com/", "ServiceImplPort"), ServiceInt.class);
    }
     ...
     */
    @WebEndpoint(name = "ServiceImplPort")
    public ServiceInt getServiceImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://ws.ad.com/", "ServiceImplPort"), ServiceInt.class, features);
    }
